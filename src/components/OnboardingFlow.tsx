        ...
        {currentStep === 2 && (
          <div className="text-center max-w-md">
            <div className="mb-8">
              ...
              <div className="bg-gray-700 rounded-lg p-4 relative">
                <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-4 h-4 bg-gray-700 rotate-45"></div>
                <p className="text-lg">Let's set up a learning routine!</p>
              </div>
            </div>
            <p className="text-gray-400 mb-8">We'll send you friendly reminders to help you reach your goal.</p>
          </div>
        )}
          ...
          <div className="text-center max-w-md">
            <div className="mb-8">
              ...
              <div className="bg-gray-700 rounded-lg p-4 relative mb-8">
                <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-4 h-4 bg-gray-700 rotate-45"></div>
                <p className="text-lg">Just 3 quick questions before we start your first lesson!</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="mt-8 w-full max-w-md">
          <button
            ...
            disabled={
              ...
              (currentStep === 3 && !selectedKnowledge) ||
              (currentStep === 4 && !selectedReligion)
            }
          ...
          >
            {currentStep === 1 && selectedGoal ? "I'M COMMITTED" : 
             currentStep === 6 ? "GET STARTED" : "CONTINUE"}
          </button>
